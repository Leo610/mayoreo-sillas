	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						Num. Proyecto: <input type="text" id="Proyecto" readonly="true" class="form-control">
						Cliente: <input type="text" id="Cliente" readonly="true" class="form-control">
						Fecha Alta: <input type="text" id="fecha" readonly="true" class="form-control">
				...
				/* @var $model Contabilidadingresos */
				...
				<div class="form">
					...
					<?php $form = $this->beginWidget(
						'CActiveForm',
						array(
							'id' => 'contabilidadingresos-form',
							'action' => Yii::app()->createUrl('Contabilidadingresos/Agregar'),
					...
					<?php echo $form->error($model, 'contabilidad_ingresos_identificador'); ?>
					...
					<div class="row">
						<div class="col-md-6">
							<?php echo $form->labelEx($model, 'contabilidad_ingresos_cantidad'); ?>
							<?php echo $form->textField($model, 'contabilidad_ingresos_cantidad', array('class' => 'form-control')); ?>
							<?php echo $form->error($model, 'contabilidad_ingresos_cantidad'); ?>
						</div>
						<div class="col-md-6">
							<?php echo $form->labelEx($model, 'factura'); ?>
							<?php echo $form->textField($model, 'factura', array('class' => 'form-control')); ?>
							<?php echo $form->error($model, 'factura'); ?>
						</div>
					</div>

					<?php echo $form->hiddenField($model, 'contabilidad_ingresos_identificador'); ?>

					<div class="row mt-lg">
						<div class="col-md-12 text-center">
							<?php echo CHtml::submitButton('Agregar pago', array('class' => 'btn btn-success')); ?>
