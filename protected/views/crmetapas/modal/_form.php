	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="formModalLabel">Crmetapas Formulario</h4>
			</div>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'Crmetapas-form',
	'action'=>Yii::app()->createUrl('Crmetapas/Createorupdate'),
...
<div class="row">
		<div class="col-md-6">
			<?php echo $form->labelEx($model,'duracion_dias'); ?>
