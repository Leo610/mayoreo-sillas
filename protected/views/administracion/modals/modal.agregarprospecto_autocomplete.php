				...
				<div class="form">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<?php echo $form->dropDownList($modelClientes, 'id_lista_precio', $arraylistaprecios, array('empty' => '-- Seleccione --', 'class' => 'form-control')); ?>
					...
					<div class="row">
						<div class="col-md-4">
							...
							$this->widget(
								'zii.widgets.jui.CJuiAutoComplete',
								array(
									'name' => 'autocomplete_tipoclasificacion',
									'source' => $this->createUrl('catalogos_recurrentes/Autocompletejs/9'),
									// Opciones javascript adicionales para el plugin
									'options' => array(
										'minLength' => '3',
										'select' => 'js:function(event, ui) {
				                  	$("#Clientes_cliente_tipo_clasificacion").val(ui.item.id);
				                  		$("#autocomplete_tipoclasificacion").val(ui.item.value);
				                 	}',
										'focus' => 'js:function(event, ui) {
				                      return false;
				                  }'
									...
									'htmlOptions' => array(
										'class' => 'form-control',
										'placeholder' => 'Busque o agrege'
									)
								)
							);
							?>
							<?php echo $form->hiddenfield($modelClientes, 'cliente_tipo_clasificacion', array('class' => 'form-control')); ?>
						...
						<div class="col-md-4">
							...
							$this->widget(
								'zii.widgets.jui.CJuiAutoComplete',
								array(
									'name' => 'autocomplete_comotrabajarlo',
									'source' => $this->createUrl('catalogos_recurrentes/Autocompletejs/10'),
									// Opciones javascript adicionales para el plugin
									'options' => array(
										'minLength' => '3',
										'select' => 'js:function(event, ui) {
				                  	$("#Clientes_cliente_como_trabajarlo").val(ui.item.id);
				                  	$("#autocomplete_comotrabajarlo").val(ui.item.value);
				                 	}',
										'focus' => 'js:function(event, ui) {
				                      return false;
				                  }'
							...
							?>
							<?php echo $form->hiddenfield($modelClientes, 'cliente_como_trabajarlo', array('class' => 'form-control')); ?>
						...
						<div class="col-md-4">
							...
							$this->widget(
								'zii.widgets.jui.CJuiAutoComplete',
								array(
									'name' => 'autocomplete_clientetipo',
									'source' => $this->createUrl('catalogos_recurrentes/Autocompletejs/3'),
									// Opciones javascript adicionales para el plugin
									'options' => array(
										'minLength' => '3',
										'select' => 'js:function(event, ui) {
				                  	$("#Clientes_cliente_tipo").val(ui.item.id);
				                  	$("#autocomplete_clientetipo").val(ui.item.value);
				                 	}',
										'focus' => 'js:function(event, ui) {
				                      return false;
				                  }'
							...
							?>
							<?php echo $form->hiddenfield($modelClientes, 'cliente_tipo', array('class' => 'form-control')); ?>
