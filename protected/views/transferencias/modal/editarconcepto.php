    ...
    <!-- Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <img src="" class="img-fluid mx-auto d-block" data-src="<?=Yii::app()->baseurl?>/images/" data-imgno="default-no-image.png" id="editarpartida_img" style="max-height: 300px;">
                    </div>
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <label>Nombre</label>
                                <input type="text" class="form-control form-control-sm" id="editarpartida_nombre" disabled="true">
                            </div>
                            <div class="col-md-12">
                                <label>Clave</label>
                                <input type="text" class="form-control form-control-sm" id="editarpartida_clave" disabled="true">
                            </div>
                            <div class="col-md-12">
                                <label>Unitario *</label>
                                <input type="number" class="form-control form-control-sm" id="editarpartida_unitario" onchange="Obtenertotal(2)">
                            </div>
                            <div class="col-md-12">
                                <label>Cantidad *</label>
                                <input type="number" class="form-control form-control-sm" id="editarpartida_cantidad" onchange="Obtenertotal(2)">
                            </div>
                            <div class="col-md-12">
                                <label>Total</label>
                                <input type="number" class="form-control form-control-sm" id="editarpartida_total" disabled="true">
                            </div> 
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <hr>
                        <button type="submit" class="btn btn-success" onclick="Actualizarproducto();"><i class="fa fa-check-circle"></i> Actualizar concepto</button>
...
<script type="text/javascript">
    ...
    function Actualizarproducto()
    {
        ...
        var jqxhr = $.ajax({
            url: "<?php echo $this->createUrl("transferencias/actualizarproductotr"); ?>",
            type: "POST",
            dataType : "json",
            timeout : (120 * 1000),
            data: {
