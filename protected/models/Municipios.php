...
class Municipios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Municipio_Nombre', 'length', 'max'=>200),
			array('Municipio_SEO', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID_Municipio, ID_Entidad, Municipio_Nombre, Municipio_SEO', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('Municipio_Nombre',$this->Municipio_Nombre,true);
		$criteria->compare('Municipio_SEO',$this->Municipio_SEO,true);
