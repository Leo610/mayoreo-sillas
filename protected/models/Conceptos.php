 ...
 * @property string $concepto_nombre
 */
class Conceptos  extends
 RActiveRecord{
	...
	public function rules()
	{
		...
		return array(
			array('concepto_nombre', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_concepto, concepto_nombre', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('concepto_nombre',$this->concepto_nombre,true);
