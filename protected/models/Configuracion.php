 ...
 */
class Configuracion  extends RActiveRecord{
	...
	public function rules()
	{
		...
		return array(
			array('id,nombre_compania,correo', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('nombre_compania, correo, telefonos, web, logotipo, direccion', 'length', 'max'=>500),
			array('descripcion', 'length', 'max'=>999),
			array('logotipo', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre_compania, descripcion, correo, telefonos, web, logotipo, direccion', 'safe', 'on'=>'search'),
		);
	}
