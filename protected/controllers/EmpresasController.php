...
{/**
	...
	public function actionEmpresasdatos()
	{
		$id = $_POST['id'];
		$Datos=Empresas::model()->findBypk($id);
	...
	/**
	 * AUTOCOMPLETE DE LA EMPRESA
	 */
	public function actionAutocompletejs()
	{
