...
{/**
	...
	{
		$id = $_POST['Formasdepago']['id_formapago'];
	...
	public function actionAdmin()
	{
		...
		$lista= Formasdepago::model()->findAll();
	 ...
	 * @return Formasdepago the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Formasdepago::model()->findByPk($id);
		return $model;
	}

	/**
	 * Performs the AJAX validation.
	 * @param Formasdepago $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='Formasdepago-form')
		{
	...
	public function actionFormasdepagodatos()
	{
		$id = $_POST['id'];
		$Datos=Formasdepago::model()->findBypk($id);
